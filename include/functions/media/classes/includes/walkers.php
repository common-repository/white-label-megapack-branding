...
/**
 * Wlmpb Media Categories Walkers
 *
 ...
 * @since 0.1.0
 */
class WLMPB_Media_Categories_Filter_Walker extends Walker_CategoryDropdown {
 ...
 * @since 0.1.0
 */
class WLMPB_Media_Categories_Media_Grid_Walker extends Walker_CategoryDropdown {
 ...
 * @since 0.1.0
 */
class WLMPB_Media_Categories_Checklist_Walker extends Walker {
